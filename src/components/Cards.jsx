    ...
    <div className="relative flex xl:justify-end justify-center xl:pt-28 pt-[30px] 2xl:w-[50%] w-full z-100">
      <div className="2xl:w-[500px] xl:w-[400px] lg:w-[500px] md:w-[450px] sm:w-[70vw] w-[65vw]">
        ...
        >
          ...
          <div className={`${currentSlide==4?"opacity-30":"opacity-100"} cursor-pointer flex justify-center items-center swiper-button-prev1 w-[25px] h-[25px] text-[25px] sm:w-[30px] sm:h-[30px] sm:text-[30px] rounded-full bg-gray-300 absolute top-[50%] right-[-100px] sm:right-[-120px] cursor-pointer mx-12 text-gray-800 z-10000`}>
            &gt;
          </div>
          <div className={`${currentSlide==0?"opacity-30":"opacity-100"} cursor-pointer flex justify-center items-center swiper-button-next1 w-[25px] h-[25px] text-[25px] sm:w-[30px] sm:h-[30px] sm:text-[30px] rounded-full bg-gray-300 absolute top-[50%] left-[-100px] sm:left-[-120px] cursor-pointer mx-12 text-gray-800 z-10000`}>
            &lt;
          </div>
        </Swiper>
      </div>
